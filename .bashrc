...
alias hwmon="lspci -nn; echo 'TEMPERATURE: ACPI | Skylake | CPU | Wifi (more info install lm_sensors, and run: sudo sensors-detect; sensors)'; cat /sys/class/thermal/thermal_zone*/temp; sudo lshw; cat /proc/cpuinfo; sudo lsusb; sudo libinput list-devices; sudo udevadm info --export-db"
